...
//	return false;
   ...
   function CategoryEditor(args) {
    ...
    this.init = function () {
      ...
      $input = $('<div style="max-height:320px;overflow:auto;" class="editorcats"></div>')
          .appendTo($wrapper);
...
//		}
      ...
      $wrapper = $('<DIV id="gallerydiv" style="z-index:100;position:absolute;background:white;padding:15px;padding-bottom:10px;border:3px solid gray; -moz-border-radius:5px; border-radius:5px;max-height: 400px;overflow: auto;"/>')
          .appendTo($container);
...
//      return (!($input.val() == "" && defaultValue == null)) && ($input.val() != defaultValue);
   ...
   function ImageEditor(args) {
    ...
    this.init = function () {
      ...
      $wrapper = $("<DIV id='w3-imagewrapper' style='z-index:100;position:absolute;background:white;padding:15px;padding-bottom:10px;border:3px solid gray; -moz-border-radius:5px; border-radius:5px;max-height: 300px;overflow: auto;'/>")
          .appendTo($container);
