		...
		<div id="content-area" class="clearfix">
			...
			<?php while ( have_posts() ) : the_post(); ?>
				...
				<?php  } ?>
					...
					?>
					<?php echo '<div class="social_under_post"><span class="social_under_post_label">Partager le post:</span>'. do_shortcode('[feather_share size="32" show="facebook, twitter, instagram, flickr, youtube" hide="google_plus, pinterest, linkedin, mail"]') . do_shortcode('[feather_follow size="32"]').'</div>'; ?>
					</div> <!-- .entry-content -->
					<div class="et_post_meta_wrapper">
					<?php
